    ...
    <div class="container">
        <div class="row">
            <div class="col-6 bg-light">
                ...
                <form>
                    <div class="mb-3 row">
                        ...
                        <div class="col">
                            <input type="text" class="form-control" v-model.trim="form.nome">
                        </div>
                    </div>
                    <div class="mb-3 row">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col">
                            <input type="password" class="form-control" v-model.number="form.senha">
                        </div>
                    </div>
                    <div class="mb-3 row">
            ...
            <div class="col-6 text-white bg-secondary">
                <span class="fs-4">ESTADO DO OBJETO {{ form }}</span>
                <hr>
                <div class="mb-5 row">
